...
extension TimelineViewController: NSTableViewDelegate {
    ...
    func tableView(_ tableView: NSTableView, heightOfRow row: Int) -> CGFloat {
        ...
        measurementHostingView.rootView = AnyView(TimelineItemRowView(rowInfo: item.rowInfo, timeline: nil, includeProfileHeader: shouldIncludeProfileHeader(at: row), coordinator: coordinator))
